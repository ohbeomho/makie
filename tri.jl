...
linesegments!(tri2, color=@lift([$a == pi / 2 ? RGBAf(0, 0, 0, 0) : RGBAf(1, 1, 1, 0.5), :white, :blue]))
...
text!(1.25, 0.6, text=@lift("tan A = $($a == pi / 2 ? "∞" : floor(tan($a), digits=3))"), color=:blue, align=(:center, :center))
